from logger_dev import logger, toaster
import tools_dev
...
class MacroDriver:
    ...
    def change_pause_state(self):
        ...
        item = main_dev.pystray.MenuItem("Pause", main_dev, checked=lambda item: self.pause_state)
    ...
    def Button_handlerV2(self, buttonNumber, macroMode):
        ...
        focused_window = tools_dev.get_focused()
        ...
        match [app, buttonNumber, macroMode]:
            ...
            case [_, "1", mode]:    # Shows what each button is defined as
                ...
                twrv = threading.Thread(target = tools_dev.ButtonMode, args=(mode, )).start()   
            ...
            case [_, "3", mode]:    # move desktop left for any app
                twrv = threading.Thread(target = tools_dev.change_desktop, args=('left', app)).start()

            case [_, "4", mode]:     # move desktop right for any app   
                twrv = threading.Thread(target = tools_dev.change_desktop, args=('right', app)).start()
            ...
            case [_, "B", mode]:     # Pause button press
                ...
                #main_dev.on_clicked(None, lambda item: True)
